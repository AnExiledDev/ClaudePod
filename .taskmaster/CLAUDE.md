...
- Check MCP server installation with `claude mcp list`
- Verify Node.js installation and Docker availability
- Use `--mcp-debug` flag when starting Claude Code
- Use CLI as fallback if MCP unavailable
- Manually reinstall servers with `claude mcp add` commands
